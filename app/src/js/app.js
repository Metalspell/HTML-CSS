...
document.getElementsByClassName('years')[4].style = "display: none";
document.getElementsByClassName('link-to-work')[0].style = "display: none";
...
document.getElementsByClassName('link-to-work')[4].style = "display: none";
document.getElementsByClassName('description')[4].style = "display: none";
document.getElementsByClassName('position')[4].style = "display: none";
